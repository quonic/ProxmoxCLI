...
function New-NodeQemu {
	...
	if ($args -and -not [String]::IsNullOrEmpty($args) -and -not [String]::IsNullOrWhiteSpace($args)) { $Options.Add('args', $args) }
	...
	if ($cipassword -and -not [String]::IsNullOrEmpty($cipassword) -and -not [String]::IsNullOrWhiteSpace($cipassword)) { $Options.Add('cipassword', $cipassword) }
...
function New-NodeLxc {
	...
	if ($onboot) { $Options.Add('onboot', $onboot) }
	if ($ostype -and -not [String]::IsNullOrEmpty($ostype) -and -not [String]::IsNullOrWhiteSpace($ostype)) { $Options.Add('ostype', $ostype) }
	if ($password -and -not [String]::IsNullOrEmpty($password) -and -not [String]::IsNullOrWhiteSpace($password)) { $Options.Add('password', $password) }
	if ($pool -and -not [String]::IsNullOrEmpty($pool) -and -not [String]::IsNullOrWhiteSpace($pool)) { $Options.Add('pool', $pool) }
	if ($protection) { $Options.Add('protection', $protection) }
