Feature: A proper community module
    ...
    Background: we have a module
        Given the module was named ProxmoxCLI
    ...
    Scenario: Should have correct module structure in source
        ...
        And it will have a private folder for private functions
        And it will have a private\*.ps1 file for a private function
